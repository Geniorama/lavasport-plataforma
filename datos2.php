  ...
  <div class="container">
    <form id="contact-form" method="post" action="recibo.php" role="form">
      ...
      <div class="controls">
        ...
        <div class="row">
          <h2 class="tituLog">INGRESE LOS SIGUIENTES DATOS</h2>
        </div>
        <div class="row">
          <div class="col-sm-4">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input id="documento" type="text" name="documento" min="0" max="9" onKeyPress="return validarNumero(event)" value="<?php echo $_GET["doc"]; ?>" class="form-control" placeholder="Ingrese el Documento*" required="required" data-error="Documento es Requerido">
              <div class="help-block with-errors"></div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <input id="nacimiento" type="date" name="nacimiento" required="required" class="form-control" placeholder="Fecha de Nacimiento">
              <div class="help-block with-errors"></div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="apellido1" type="text" name="apellido1" class="form-control" placeholder="Ingrese el Pimer Apellido *" required="required" data-error="Primer Apellido Rquerido.">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="apellido2" type="text" name="apellido2" class="form-control" placeholder="Ingrese el Segundo Apellido *" required="required" data-error="Segundo Apellido Requerido.">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="nombres" type="text" name="nombres" class="form-control" placeholder="Ingrese los Nombres *" required="required" data-error="Nombres Requeridos.">
            <div class="help-block with-errors"></div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="correo" type="email" name="correo" class="form-control" placeholder="Ingrese el Correo Electronico *" required="required" data-error="El Correo Electronico es requerido">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="telefono" type="tel" name="telefono" class="form-control" placeholder="Ingrese El Telefono *" required="required" data-error="El Telefono  es requerido">
            <div class="help-block with-errors"></div>
          </div>
        </div>
     <div class="col-sm-4">
          <div class="form-group">
            <label for="form_phone">Solicitar Código de verificación para Continuar (código al whatsapp)</label>
      ...
      <div class="row" id="racud1" style="display:none">
        <div class="col-sm-4">
          <div class="form-group">
            <label for="form_email">Documento del Acudiente *</label>
            <input id="docacudiente" type="text" name="docacudiente" class="form-control" placeholder="Ingrese el Documento del Acudiente ">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="apellidoacudiente" type="text" name="apellidoacudiente" class="form-control" placeholder="Ingrese El Apellido Del Acudiente *">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="apellido2acudiente" type="text" name="apellido2acudiente" class="form-control" placeholder="Ingrese El Apellido Del Acudiente *">
            <div class="help-block with-errors"></div>
          </div>
        </div>
      </div>
      <div class="row" id="racud2" style="display:none">

        <div class="col-sm-4">
          <div class="form-group">
            <label for="form_email">Nombres del Acudiente *</label>
            <input id="nombresacudiente" type="text" name="nombresacudiente" class="form-control" placeholder="Nombres del Acudiente">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="correoacudiente" type="email" name="correoacudiente" class="form-control" placeholder="Ingrese El Correo Electronico *">
            <div class="help-block with-errors"></div>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input id="numeroacudiente" type="tel" name="numeroacudiente" class="form-control" placeholder="Ingrese El Numero Celular del Acudiente *">
            <div class="help-block with-errors"></div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          se a enviado un codigo a su telefono Registrado via whatsapp, si no llega en los proximos 2 minutos vuelva a intentarlo.
        </div>
        <div class="modal-footer">
