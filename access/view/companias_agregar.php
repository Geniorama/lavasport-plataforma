...
<h4><?php echo __("Nuevo Compania"); ?></h4>

<form id="companias-agregando" name="companias-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>companias/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#companias-agregando").submit(function(){
