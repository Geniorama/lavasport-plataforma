<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Editar Grado</li>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			<form id="grados-editando" name="grados-editando" class="form-horizontal" method="post" action="<?php echo PATO; ?>grados/editando/<?php echo $this->valor[0]; ?>/" enctype="multipart/form-data">
