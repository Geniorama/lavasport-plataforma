...
<h4><?php echo __("Nuevo Organizacion"); ?></h4>

<form id="organizaciones-agregando" name="organizaciones-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>organizaciones/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#organizaciones-agregando").submit(function(){
