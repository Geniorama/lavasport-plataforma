...
<h4><?php echo __("Nuevo Grado"); ?></h4>

<form id="grados-agregando" name="grados-agregando" class="form-horizontal" method="post" action="<?php echo PATO; ?>grados/agregando/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#grados-agregando").submit(function(){
