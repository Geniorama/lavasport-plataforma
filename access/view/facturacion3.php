 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Facturacion Cupo</li>
 ...
 <section class="content">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Facturación Cupo</h3>
      ...
      <div class="box box-default">
        ...
        <form action="<?php echo PATO; ?>productocupos/facturacion3filtro/" method="post" name="ciudades-filtrar" id="ciudades-filtrar" class="form-inline navbar-text">
...
<?php if(isset($_POST["fecha1"])){ 
  ...
  ?>
	...
	while(!$sale->EOF){ 
$valoriva=$sale->fields["pagos1"]*0.19;

    ?>

                <tr>

				  <td><?php echo $sale->fields["factura"]; ?></td>
       <td><?php echo $sale->fields["fechapago"]; ?></td>    
            <td><?php echo $sale->fields["nit"]; ?></td>    
              <td><?php echo $sale->fields["cliente"]; ?></td>    
                <td class="text-right"><?php echo number_format($sale->fields["pagos1"]-$valoriva,0,',','.'); ?></td>    
                  <td class="text-right"><?php echo number_format($valoriva,0,',','.'); ?></td>    
                    <td class="text-right">19%</td>    
                    <td class="text-right"><?php echo number_format($sale->fields["pagos1"],0,',','.'); ?></td>         
       <td>PAGO CUPO</td>  
       <td><?php echo $sale->fields["cuponombre"]; ?></td>         
       <td><?php echo $sale->fields["codigocliente"]; ?></td>   
