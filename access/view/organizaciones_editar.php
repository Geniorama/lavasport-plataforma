<h4><?php echo __("Editar Organizacion"); ?></h4>

<form id="organizaciones-editando" name="organizaciones-editando" class="form-horizontal" method="post" action="<?php echo PATO; ?>organizaciones/editando/<?php echo $this->valor[0]; ?>/" enctype="multipart/form-data">
...
$(function(){
	...
	$("#organizaciones-editando").submit(function(){
