...
<head>
  ...
  <link rel="stylesheet" href="<?php echo PATU; ?>plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body" style="background-color: #00a4e4;">



      <div class="login-logo">

        <img src="<?php echo LOGO; ?>" style="width: 310px;">

      </div>

      <form action="<?php echo PATO; ?>entrada/" method="post" name="<?php echo MODULO; ?>-entrada" method="post">
  ...
  <script src="<?php echo PATU; ?>plugins/iCheck/icheck.min.js"></script>
