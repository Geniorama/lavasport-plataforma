...
<div class="box">
 ...
 <tr>
      ...
      <div class="row">
        ...
        <td><?php echo $sale->fields["productos_nombre"]; ?>  
...
<td><input type="text" id="comment<?php echo $sale->fields["id"]; ?>" name="comment<?php echo $sale->fields["id"]; ?>" onchange="editarcoment(<?php echo $sale->fields["id"]; ?>)" value="<?php echo $sale->fields["observacione_id"]; ?>" ><button class="btn-success"><i class="fa fa-save"></i></button></td>
