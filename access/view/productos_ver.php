...
<div class="row">
	<div class="col-5"><?php echo __("Moneda"); ?></div>
	<div class="col-7"><?php echo $sale->fields["moneda"]; ?>	</div>
</div>


<div class="row">
	<div class="col-5"><?php echo __("Peso"); ?></div>
	<div class="col-7"><?php echo $sale->fields["peso"]; ?>	</div>
</div>
