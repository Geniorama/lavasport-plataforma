 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Órdenes x producto</li>
 ...
 <section class="content">
      ...
      <div class="box box-default">
        ...
        <form action="<?php echo PATO; ?>productocupos/ordenesproductofiltro/" method="post" name="ciudades-filtrar" id="ciudades-filtrar" class="form-inline navbar-text">
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" id="id" placeholder="Numero de órden" name="id" value="<?php echo $_POST["id"]; ?>" class="form-control">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" name="compania_id[]" id="compania_id" multiple="multiple" data-placeholder="Compañía"
      ...
      <div class="box-tools pull-right">
              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <?php $total1=$this->obj->totales($_POST,2); 
                   ...
                   echo number_format(round($total1->fields["total"]),0,',','.');
          ...
          <div class="box box-default">
            ...
            <div class="box-header with-border">
              ...
              <h3 class="box-title">Órdenes Por Compañía</h3>
...
$j=1;$i=0; $e=0;$p=0;$cal=0;
	...
	while(!$sale->EOF){ ?>
           ...
           <td class="text-right"><?php echo number_format($sale->fields["cantidad"],0,',','.');?></td>

           <td class="text-right"><?php echo number_format($sale->fields["peso"],0,',','.');?></td>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title">Detalle de la órden</h4>
...
function anular(id){
  ...
  if(confirm("desea anular la orden #"+id)){ 
