...
<div class="col-md-5">
      ...
      <select class="form-control select2" name="producto_id" id="producto_id" onchange="ponercodigo()"   data-placeholder="Producto"
               ...
               <?php while(!$productos->EOF){   ?>
                        <option value="<?php echo $productos->fields["id"]; ?>" > <?php echo $productos->fields["id"]; ?> - <?php echo $productos->fields["nombre"]; ?> - <?php echo $productos->fields["peso"]; ?>gr.</option>
...
$("#peso").val(peso);
    ...
    function generarOrden(){
      ...
      if($("#documento").val()!=""){
      $("#carga").show();
$.ajax({type: "POST",url: "<?php echo PATO; ?>productocupos/generarOrden/",data: "tipo=2&cliente_id="+$("#cliente_id").val()+"&fecha_promesa="+$("#fecha_promesa").val(),
