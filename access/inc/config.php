...
if(preg_match("/multilaundry.com/i",$_SERVER["HTTP_HOST"])){
	define('MIURL','http://www.multilaundry.com');
	define('MIURLS','https://www.multilaundry.com');
	define('PATO','/lavanderia/access/');
...
//   Varios
define("URLVIEW","multilaundry.com");
define("PERFIL",'admin');
