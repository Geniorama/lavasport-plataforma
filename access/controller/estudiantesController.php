<?php
class estudiantesController extends baseControl
{
	...
	public function index()
	{
		...
		include("view/estudiantes_index.php");
	...
	public function ver()
	{
		...
		include("view/_header.php");
		include("view/estudiantes_ver.php");
		include("view/_footer.php");
	}
		...
		<div class="content-wrapper">
			...
			<section class="col-lg-12 connectedSortable ui-sortable">
				...
				if (isset($_POST['submit'])) {
					...
					echo "<h5>LAVASPORT LOG DE CARGA ESTUDIANTES</h5>";
					...
					if (strtolower(end($chk_ext)) == "csv") {
						...
						echo "<p style='color:green;'>nuevos estudiantes:" . $nuevos . "</p>";
						echo "<p style='color:green;'>estudiantes actualizados:" . $actualizados . "</p>";
					} else {
			...
			public function agregar()
			{
				...
				$escuelas = $escuelasobj->listar();
				include("view/_header.php");
				include("view/estudiantes_agregar.php");
				include("view/_footer.php");
			}
			...
			public function agregando()
			{
				...
				header("Location: " . PATO . "estudiantes/");
				exit;
			}
			...
			public function editar()
			{
				...
				include("view/_header.php");
				include("view/estudiantes_editar.php");
				include("view/_footer.php");
			}
