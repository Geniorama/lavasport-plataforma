<?php
class observacionesController extends baseControl {
	...
	public function __construct(){
		veraut();
		include_once("model/observacionesModel.php");$this->obj = new observacionesModel();
	...
	public function index(){
		...
		include("view/observaciones_index.php");
	...
	public function ver(){
		...
		include("view/_header.php");
		include("view/observaciones_ver.php");
		include("view/_footer.php");
	}
	public function verporcode(){
		$sale = $this->obj->verporcodigo($this->valor[0]);

		echo $sale->fields["observacion"]; 
	//	include("view/_header.php");
	//	include("view/observaciones_ver.php");
	//	include("view/_footer.php");
	}
	...
	public function agregar(){
		include("view/_header.php");
		include("view/observaciones_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando(){
		...
		header("Location: ".PATO."observaciones/");exit;
	}
	...
	public function editar(){
		...
		include("view/_header.php");
		include("view/observaciones_editar.php");
		include("view/_footer.php");
	}
