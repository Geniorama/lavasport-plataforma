<?php
class bancosController extends baseControl
{
	...
	{
		include("view/_header.php");
		include("view/bancos_agregar.php");
		include("view/_footer.php");
	}
	...
	public function editar()
	{
		...
		include("view/_header.php");
		include("view/bancos_editar.php");
		include("view/_footer.php");
	}
