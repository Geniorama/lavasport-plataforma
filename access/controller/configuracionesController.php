<?php
class configuracionesController extends baseControl
{
	...
	{
		veraut();
		include_once("model/configuracionesModel.php");
		$this->obj = new configuracionesModel();
	}
	...
	public function index()
	{
		...
		include("view/configuraciones_index.php");
	...
	public function ver()
	{
		...
		include("view/_header.php");
		include("view/configuraciones_ver.php");
		include("view/_footer.php");
	}
	...
	{
		include("view/_header.php");
		include("view/configuraciones_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando()
	{
		...
		header("Location: " . PATO . "configuraciones/");
		exit;
	}
	...
	public function editar()
	{
		...
		include("view/_header.php");
		include("view/configuraciones_editar.php");
		include("view/_footer.php");
	}
