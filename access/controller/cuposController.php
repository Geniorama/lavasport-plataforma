<?php
class cuposController extends baseControl {
	...
	public function __construct(){
		veraut();
		include_once("model/cuposModel.php");$this->obj = new cuposModel();
	...
	public function index(){
		...
		include("view/cupos_index.php");
		include("view/_footer.php");
	}

	public function ver(){
		$productosobj = new productosModel();$prenda= $productosobj->listar();
		$sale = $this->obj->ver($this->valor[0]);
		$sale2=$this->obj->listarprenda($this->valor[0]);
		
	
		include("view/_header.php");
		include("view/cupos_ver.php");
		include("view/_footer.php");
	}
	...
	public function agregar(){
		include("view/_header.php");
		include("view/cupos_agregar.php");
		include("view/_footer.php");
	}
	...
	public function agregando(){
		...
		header("Location: ".PATO."cupos/index/1");exit;
	}

	public function editar(){
		$sale = $this->obj->editar($this->valor[0]);
		include("view/_header.php");
		include("view/cupos_editar.php");
		include("view/_footer.php");
	}
	...
	public function eliminar(){
		...
		header("Location: ".PATO."cupos/");exit;
	}
